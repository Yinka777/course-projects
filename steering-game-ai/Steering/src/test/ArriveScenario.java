...
public class ArriveScenario {
    ...
    */
    ...
    public static void main(String args[]) throws Exception {
        ...
        Marker marker = new Marker(600,300,10, Color.green);
        GameObject car1 = new Car("Steering/graphics/redcar.png",200,300,-Math.PI/2, new SteeringController(new Arrive(marker,1)));
        game.add(marker);
        game.add(car1);
