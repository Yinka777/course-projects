...
import steering.WallAvoidanceSeek;
...
public class WallAvoidanceSeekScenario {
    ...
    */
    ...
    public static void main(String args[]) throws Exception {
        ...
        GameObject car2 = new Car("Steering/graphics/bluecar.png",600,300,-Math.PI/2, new SteeringController(new WallAvoidanceSeek(car1, 1)));
        game.add(car1);
        game.add(car2);
